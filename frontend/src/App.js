    ...
    <Router>
      <Routes>
        ...
        <Route
          ...
          element={isAuthenticated ? <Layout><OrganizationHome /></Layout> : <Navigate to="/login" />}
        />
        <Route
          path="/join-orgs"
          element={isAuthenticated ? <Layout><AvailableOrganizations /></Layout> : <Navigate to="/login" />}
        />
        <Route
          path="/profile"
